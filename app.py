    ...
    while True:
            ...
            for box in result.boxes:
                ...
                if confidence > 0.5 and class_id == 0:
                    ...
                    if matched_person_id is None:
                        ...
                        colors_dict[person_id_counter] = strong_colors[person_id_counter % len(strong_colors)]
                        person_id_counter += 1
                    else:
        ...
        for person_info in detected_people.values():
            if "orders" in person_info:
                ...
                cv2.putText(frame, f'Person {person_info["id"]} - Waiting Time: {waiting_time_str}',
                            (x, y - 10), cv2.FONT_HERSHEY_SIMPLEX, 0.5, colors_dict[person_info["id"]], 2)
                cv2.circle(frame, person_info["centroid"], 5, colors_dict[person_info["id"]], -1)
